...
|---|---:|---:|
| Apple M1 Pro / Apple clang 21 | 7.99 / 9.43 | 29.78 / 27.31 |
| Ryzen AI 9 HX PRO 370 / GCC 16 | 4.29 / 4.93 | 61.60 / 33.88 |
...
The wasm build uses no SIMD or wide multiply. These are point measurements,
not a claim that one hash is fastest on every workload or machine.
